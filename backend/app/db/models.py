...
class Node(Base):
    ...
    reference_document: Mapped[str | None] = mapped_column(String)
    access_profiles: Mapped[list[Any]] = mapped_column(JSON, default=list)
    credential_refs: Mapped[list[Any]] = mapped_column(JSON, default=list)
